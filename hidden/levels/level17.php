...
function Ball(x, y, radius, angle, speed, color) {
	...
	//canvas coordinates increase as you go towards the bottom right
...
//canvas x and y increase as you go towards the bottom right
	var yDifference = balls[i].y - balls[j].y ;
	var xDifference = balls[j].x - balls[i].x;
	...
	var angleToNext = (Math.atan2(yDifference, xDifference) * (180/Math.PI));
	//center inside vertical beam
	//((Math.atan2(0,1)) * (180/Math.PI))
