...
var ball1 = new Ball(200, 150, 10, -45, 5);
var ball2 = new Ball(200, 100, 10, 45, 5);
...
//canvas x and y increase as you go towards the bottom right **fixed**
	...
	var radiansToCurrent = radiansToNext + (Math.PI/2);
/*
...
*/
	...
	var newDxNext = ((normalY*normalY) - (normalX*normalX))*balls[j].dx - (2*normalX*normalY)*balls[j].dy; 
	var newDyNext = ((normalX*normalX) - (normalY*normalY))*balls[j].dy - (2*normalY*normalX)*balls[j].dx; 
